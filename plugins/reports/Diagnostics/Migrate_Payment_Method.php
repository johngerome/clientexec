...
class Migrate_Payment_Method extends Report
{
    ...
    function process()
    {
        ...
        echo "<div>".$this->user->lang("The credit card number and expiration month and year of the customers using the selected payment methods will be migrated to an account in Stripe Checkout")."<br/>"
            ."<b>".$this->user->lang("WARNING").":</b> ".$this->user->lang("Before trying to run this migration, please follow these steps").":"
            ."<ol>"
            ."<li>".$this->user->lang("Login to your <i><a href='https://dashboard.stripe.com/login' target='_blank'>Stripe Dashboard</a></i>")."</li>"
            ."<li>".$this->user->lang("Go to <i><a href='https://dashboard.stripe.com/account/integration/settings' target='_blank'>Settings > Compliance and reporting > Integration</a></i>")."</li>"
            ."<li>".$this->user->lang("Click on <i>Show advanced options</i>")."</li>"
            ."<li>".$this->user->lang("Enable <i>Handle card information directly</i>")."</li>"
            ."<li>".$this->user->lang("Now, you should be ready to run this migration")."</li>"
            ."<li>".$this->user->lang("When done, please repeat the steps to disable <i>Handle card information directly</i>")."</li>"
            ."</ol>"
            ."</div><br/>";
