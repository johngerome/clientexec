...
class PluginPhpsysinfo extends SnapinPlugin
{
    ...
    function bar($value, $width)
    {
        ...
        if ($value != "0") {
            $strHTML .= "<td width=\"$value%\" background={$relative}plugins/snapin/phpsysinfo/images/$prefix-active.gif><img src={$relative}plugins/snapin/phpsysinfo/images/zero.gif width=\"1\" height=\"1\"></td>";
        }
        if ($value != "100" && $value != "0") {
            $strHTML .= "<td width=\"4\"><img src={$relative}plugins/snapin/phpsysinfo/images/$prefix-divider.gif></td>";
        }
        if ($value != "100") {
            $strHTML .= "<td width=\"$left%\"><img src={$relative}plugins/snapin/phpsysinfo/images/zero.gif width=\"1\" height=\"1\"></td>";
        }
        if ($value != "100" && $value != "0") {
            $strHTML .= "<td width=\"3\" align=\"right\"><img src={$relative}plugins/snapin/phpsysinfo/images/$prefix-end.gif></td>";
        }
        if ($value == "0" || $value == "100") {
            $strHTML .= "<td width=\"2\" align=\"right\"><img src={$relative}plugins/snapin/phpsysinfo/images/$prefix-zeroend.gif></td>";
        }
        $strHTML .= "</tr>";
        $strHTML .= "</table>";
